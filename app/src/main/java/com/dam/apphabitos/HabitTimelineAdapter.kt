...
class HabitTimelineAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.item_habit_timeline, parent, false)
        return VH(v)
    }
